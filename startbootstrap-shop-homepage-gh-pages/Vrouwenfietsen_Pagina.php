...
<head>
    ...
    <title>Vrouwenfietsen | Chain Gang</title>
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                ...
                <a href="Vrouwenfietsen_Pagina.php" class="list-group-item" style="color: black;">Vrouwenfietsen</a>
                <a href="Kinderfietsen_Pagina.php" class="list-group-item">Kinderfietsen</a>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">
                                <a href="#" style="color:black;">Item Seven</a>
                            </h4>
                            <h5>$24.99</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">
                                <a href="#" style="color:black;">Item Eight</a>
                            </h4>
                            <h5>$24.99</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">
                                <a href="#" style="color:black;">Item Nine</a>
                            </h4>
                            <h5>$24.99</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">
                                <a href="#" style="color:black;">Item Ten</a>
                            </h4>
                            <h5>$24.99</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">
                                <a href="#" style="color:black;">Item Eleven</a>
                            </h4>
                            <h5>$24.99</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">
                                <a href="#" style="color:black;">Item Twelve</a>
                            </h4>
                            <h5>$24.99</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!</p>
                        </div>
